...
const Card = ({title, description, image} : ICardProps) => {
    return (
        <div className="m-10 p-10 shadow-lg flex flex-col items-center max-w-sm bg-white border border-gray-300 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
